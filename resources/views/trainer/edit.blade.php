...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-body">
                <form action="{{ url('update-trainer/'.$trainer->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label for="">Trainer Name</label>
                        <input type="text" class="form-control" name="tr_name" value="{{$trainer->tr_name}}">
                    </div>
                    <div class="form-group">
                        <label for="">Trainer Title</label>
                        <input type="text" class="form-control" name="tr_title" value="{{$trainer->tr_title}}">
                    </div>
                    <div class="form-group">
                        <label for="">Trainer Image</label>
                        <input type="file" class="form-control" name="tr_image">
                        <img src="{{ asset('uploads/trainers/'.$trainer->tr_image)}}" alt="image" height="70px" width="70px">
                    </div>
                    <div class="form-group">
