            ...
            <div class="box-body">
                <form action="{{ url('update-article/'.$article->id )}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ar_name" placeholder="Enter the Article name" value="{{ $article->ar_name }}">
                    </div>
                    <div class="form-group">
                        <label for="">Article Details:</label>
                        <input type="text" class="form-control" name="ar_details"
                            placeholder="Enter the Article details" value="{{ $article->ar_details }}">
                    </div>
                    <div class="form-group">
                        <label for="">Article Image:</label>
                        <input type="file" class="form-control" name="ar_image">
                        <img src="{{ asset('uploads/articles/'.$article->ar_image)}}" alt="image">
                    </div>
                    <div class="form-group">
